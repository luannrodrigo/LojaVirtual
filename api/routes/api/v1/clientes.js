...
router.get('/search/:search/pedidos', auth.required, LojaValidation.admin, Validation(ClienteValidation.searchPedidos), clienteController.searchPedidos); //para pesquisar dos pedidos
...
router.get('/admin/:id/:pedidos', auth.required, LojaValidation.admin, Validation(ClienteValidation.showPedidosClientes), clienteController.showPedidosClientes);
